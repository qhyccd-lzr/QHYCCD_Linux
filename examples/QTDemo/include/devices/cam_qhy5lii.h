#ifndef CAM_QHY5LII_H
#define CAM_QHY5LII_H
#include "camera.h"
...
class cam_qhy5lii_params : public cam_base_params
{
public:
        cam_qhy5lii_params() : cam_base_params( 500 )
        {
                reset();
        }
        virtual ~cam_qhy5lii_params(){}
        virtual void reset()
        {
...
private:
        static const camera_model::model m_model = camera_model::qhy5lii;
};
...
class ccamera_qhy5lii : public ccamera_base
{
        Q_OBJECT
public:
        ccamera_qhy5lii();
        virtual ~ccamera_qhy5lii();
...
private:
        ...
        cam_qhy5lii_params m_high_params;	// human-readable params
        qhy5lii_params_t   m_low_params;

        qhy5lii_core_shared *m_qhy5lii_obj;
