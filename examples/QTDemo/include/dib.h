...
extern u_char *LoadDIBitmap(const char *filename, int *width, int *height, int *bpp );
extern int     SaveDIBitmap(const char *filename, int width, int height, int bpp, u_char *bits);
